...
public class SplashScreen : MonoBehaviour
{
    ...
    public int levelToLoad; // this has to correspond to a level (file>build settings)
    private Texture2D splashLogo; // the logo to splash;
	private Color splashColor = new Color(0, 0, 0, 1); // the logo to splash;
